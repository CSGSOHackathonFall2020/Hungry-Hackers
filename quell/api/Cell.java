...
/**
 * Represents one cell of the CS227Quell game grid.  A cell always
 * has a state, represented by one of the <code>CellState</code>
...
public class Cell
{
     ...
     *   state for this Cell
     */
    public Cell(CellState givenState)
    {
        state = givenState;
    }
