...
public class GUIMain
{
    ...
    {
        CS227Quell g = new CS227Quell(ConsoleUI.test1, new GameSupport());
        start(g);
    }
     ...
     * @param game
     */
    private static void start(final CS227Quell game)
    {
     ...
     * @param sleepTime
     */
    private static void createAndShow(final CS227Quell game)
    {
        ...
        // create the frame
        JFrame frame = new JFrame("CS227Quell");
